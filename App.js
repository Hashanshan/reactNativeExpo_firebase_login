...
const profilePicture = 'https://randomuser.me/api/portraits/men/33.jpg'
          ...
          <BlurView intensity={100}>
            <View style={styles.login}>
              ...
              <View>
                ...
                <TextInput onChangeText={(text) => setEmail(text)} style={styles.input} placeholder="sathihashan@gmail.com" />
              </View>
              <View>
